...
public class Sanity {
	...
	@Test(priority = 1, enabled = true, description = "Going to registration")
	...
	@Test(priority = 2, enabled = true, description = "Select Account type")
	...
	@Test(priority = 3, enabled = true, description = "Verify if filter is working")
	...
	@Test(priority = 4, enabled = true, description = "Verify page URL")
